...
run '! rg -q autoPlay src/components/ads/CreativeCard.tsx src/components/dashboard/CreativesGrid.tsx src/components/creatives/CreativePreview.tsx'
run 'rg -q "const \\[mediaError, setMediaError\\]" src/components/creatives/CreativePreview.tsx'
run 'rg -q CreativePreview src/components/dashboard/CreativesGrid.tsx'
