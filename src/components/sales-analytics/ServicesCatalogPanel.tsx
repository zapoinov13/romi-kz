...
export function ServicesCatalogPanel({ items, loading, onAdd, onUpdate, onRemove }: Props) {
    ...
    <div className="space-y-4">
      <div className="grid gap-3 rounded-lg border border-border/60 p-3 sm:grid-cols-[1fr_120px_auto]">
        <div>
          ...
          <Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Имплантация" />
        </div>
        <div>
